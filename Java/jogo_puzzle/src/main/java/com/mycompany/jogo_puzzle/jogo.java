...
public class jogo extends javax.swing.JFrame {
	...
	// atribuicao do texto para declarar a mensagem de vitoria 
        Caixa_Vitoria.setToolTipText("");
	
	//atribuicao do texto para declarar o numero de jogadas  
        Numero_Jogadas.setText("Jogada Nº");
	
	//atribuicao do texto do timer
	...
	//metodos executados a partir de click dos botoes 
    private void B2ActionPerformed(java.awt.event.ActionEvent evt) {                                   
        
	//executando a funcao .movimento da classe Codigo1 estanciada 
        a.movimento(B2, B1, B3, B6,Numero_Jogadas);
        
	//teste para verificar se foi a primeira movimentacao de peca assim dando inicio ao jogo
        if(!teste){
	...
	//criacao do vetor para salvar as posicoes dos botoes do jogo
	...
	//condicao para realizar o registro das posicoes no vetor criado
	//visto que esse if era verificado quando o botao 16 estiver vazio por ter sido movimentado e os botoes 1, 4, 13 estarem em suas devidas posicoes de vitoria 
	...
	//utilizacao do metodo vitoria  atribuido a classe Codigo1 informando o vetor do jogo e a label de vitoria
        a.vitoria(posicao,Caixa_Vitoria);
        
	// se a label de vitoria tiver validada corretamente com a frase de vitoria e feito o embaralhamento e tambem zerado o timer 
        if(Caixa_Vitoria.getText().equals("VOCE VENCEU!"))
        {
            a.embaralhar(posicao,B1,B2,B3,B4,B5,B6,B7,B8,B9,B10,B11,B12,B13,B14,B15,B16,Caixa_Vitoria, Numero_Jogadas);
            teste = false;
            //Time.setText("Time: 00:00:00");
        }
    }                                   
